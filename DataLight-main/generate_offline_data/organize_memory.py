...
def collect_one_flow_data(path0, flow_path='JN', flow_path2='1', index=0):
    ...
    for path1 in methods_path:
        ...
        for inter_id in range(total_inters):
            ...
            tmp_full_path = os.path.join(path0, 'records/benchmark_1001/', 'anon_4_4_hangzhou_real_5816.json_11_19_22_00_23', 'train_round/', sample_path)
...
if __name__ == '__main__':
    ...
    save_final_data(data4, "./random_hz_100_round_fully_cyclic_5816.pkl")

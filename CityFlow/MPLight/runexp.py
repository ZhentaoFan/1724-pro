...
def parse_args():
    ...
    parser.add_argument("--memo",       type=str,           default='exp_20230210_TransferDQNPressOne')
    ...
    parser.add_argument("--mod",        type=str,           default="TransferDQNPressOne")
...
def main(args = None):
    ...
    if args.uniform:
        ...
        traffic_file_list = [ENVIRONMENT + "_" + args.road_net + "_%d_%s_synthetic.json" % (v, r) for v in [700,750] for r in
                             [0.3,0.6]]
        args.cnt = 3600
        args.lane = 3
        num_rounds = 700
